...
extern "C" void ISRHandler(registers_t *r) {
  if (r->isrNumber < 32) {
    ...
    asm volatile(
        ...
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("RBX: ", StringConcatenate("0x", ToHexNumberString(r->rbx))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("RCX: ", StringConcatenate("0x", ToHexNumberString(r->rcx))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("RDX: ", StringConcatenate("0x", ToHexNumberString(r->rdx))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("RBP: ", StringConcatenate("0x", ToHexNumberString(r->rbp))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("RDI: ", StringConcatenate("0x", ToHexNumberString(r->rdi))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("RSI: ", StringConcatenate("0x", ToHexNumberString(r->rsi))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R8:  ", StringConcatenate("0x", ToHexNumberString(r->r8))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R9:  ", StringConcatenate("0x", ToHexNumberString(r->r9))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R10: ", StringConcatenate("0x", ToHexNumberString(r->r10))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R11: ", StringConcatenate("0x", ToHexNumberString(r->r11))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R12: ", StringConcatenate("0x", ToHexNumberString(r->r12))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R13: ", StringConcatenate("0x", ToHexNumberString(r->r13))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R14: ", StringConcatenate("0x", ToHexNumberString(r->r14))), IColor::RGB(255, 0, 0));
        HY_IDT_CONSOLE->WriteLine(StringConcatenate("R15: ", StringConcatenate("0x", ToHexNumberString(r->r15))), IColor::RGB(255, 0, 0));
